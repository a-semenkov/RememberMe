const FIREBASE_AUTH_ERROR_CODES = {
  ...
  'storage/invalid-url	Invalid':
    'URL provided to refFromURL(). Must be of the form: gs://bucket/object or https://firebasestorage.googleapis.com/v0/b/bucket/o/object?token=<TOKEN>',
...
export default FIREBASE_AUTH_ERROR_CODES;
